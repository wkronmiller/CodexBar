...
struct StatusProbeTests {
    ...
    @Test
    func parseCodexStatusWithSparkQuota() throws {
        let sample = """
        Credits: 420 credits
        5h limit: [██████    ] 60% left (resets 10:45)
        Weekly limit: [█████     ] 55% left (resets Tue at 9:00 AM)
        GPT-5.3 Codex Spark quota: [███       ] 35% left (resets Thu at 9:00 AM)
        """
    ...
    @Test
    func parseCodexStatusWithGPT53CodexQuotaWithoutSparkWord() throws {
        let sample = """
        Credits: 420 credits
        5h limit: [██████    ] 60% left (resets 10:45)
        Weekly limit: [█████     ] 55% left (resets Tue at 9:00 AM)
        GPT-5.3 Codex quota: [███       ] 35% left (resets Thu at 9:00 AM)
        """
