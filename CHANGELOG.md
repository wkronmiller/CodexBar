...
- z.ai: new provider support with Tokens + MCP usage bars and MCP details submenu; usage bars now respect the show-used toggle. Thanks @uwe-schwarz for the initial work!
