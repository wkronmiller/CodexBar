...
public struct OpenAIDashboardFetcher {
        ...
        timeout: TimeInterval = 60) async throws -> OpenAIDashboardSnapshot
    {
        ...
        while Date() < deadline {
            ...
            let hasUsageLimits = rateLimits.primary != nil || rateLimits.secondary != nil || rateLimits.tertiary != nil

            if anyDashboardSignalAt == nil,
               !usageBreakdown.isEmpty || scrape.creditsHeaderPresent ||
            ...
            if events.isEmpty,
               !usageBreakdown.isEmpty || hasUsageLimits || creditsRemaining != nil
            {
                log(
            ...
            if !events.isEmpty || !usageBreakdown.isEmpty || hasUsageLimits || creditsRemaining != nil
            {
                return OpenAIDashboardSnapshot(
                    ...
                    tertiaryLimit: rateLimits.tertiary,
